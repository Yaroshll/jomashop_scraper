...
const TARGET_URL = "https://www.jomashop.com/watches.html?sort=saving%7Cdesc&p=450"; // Example: Philipp Plein category
const MIN_DISCOUNT = 80; // Minimum discount percentage (set to 0 to ignore discounts)
